...
const Contact = () => {
  ...
  // Replace with your field entry IDs from Google Form
  const fieldIds = {
    name: "entry.123456",
    email: "entry.654321",
    subject: "entry.111111",
    message: "entry.222222",
  };
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSend.append(fieldIds.name, formData.name);
    formDataToSend.append(fieldIds.email, formData.email);
    formDataToSend.append(fieldIds.subject, formData.subject);
    formDataToSend.append(fieldIds.message, formData.message);
